...
<head>
    <meta charset="UTF-8">
    <title>Tableau de Bord Chef de Filière - Cahier Texte UPF</title>
...
<body>
    <div class="dashboard">
        <div class="sidebar">
            ...
            <div class="menu-item">
                <a href="index.jsp" class="text-white">Tout les cours </a>
            </div>
            <div class="menu-item">
        ...
        <div class="content">
            <div class="dashboard-container">
                <h1 class="dashboard-title">Chef de Filière</h1>

                <!-- Informations fictives -->
                <div class="dashboard-card">
                    <h2>Informations</h2>
                    <p>Nom du Chef de Filière: Jean</p>
                    <!-- Ajoutez ici les autres informations du chef de filière -->
                </div>

                <!-- Statistiques avec animation -->
                <div class="dashboard-card stats-container">
                    <h2>Statistiques Cahier de Texte</h2>
    ...
    <script>
        ...
        var statsChart = new Chart(ctx, {
            ...
            data: {
                labels: ['Cours Entrés', 'Cours Non Entrés'],
                datasets: [{
                    data: [75, 25], // Remplacez par vos données réelles
